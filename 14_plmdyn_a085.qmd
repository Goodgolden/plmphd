...
plt0_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt1_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt2_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt3_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt4_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt5_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
...
plt0_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% group_by(id) %>% slice(1L),
                 outcome_var = "ht",
                 time_var = "time",
...
plt1_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% filter(time <= 1) %>% group_by(id),
                 outcome_var = "ht",
                 time_var = "time",
...
plt2_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% filter(time <= 2) %>% group_by(id),
                 outcome_var = "ht",
                 time_var = "time",
...
plt3_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% filter(time <= 3) %>% group_by(id),
                 outcome_var = "ht",
                 time_var = "time",
...
plt4_4anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% filter(time <= 4) %>% group_by(id),
                 outcome_var = "ht",
                 time_var = "time",
...
plt5_3anchor <- people_like_thee2(train_data = train,
                 test_data = test,
                 new_data = test %>% filter(time <= 5) %>% group_by(id),
                 outcome_var = "ht",
                 time_var = "time",
...
Ma0.85 <- bind_rows(plt03, plt13, plt23,
                   plt33, plt43, plt53,
                   plt04, plt14, plt24,
                   plt34, plt44, plt54)

save(Ma0.85, file = here::here("results", "M15_gender_m0.85_plt12345_3anchor_4anchor.rda"))
